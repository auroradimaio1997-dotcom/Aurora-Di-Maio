...
//
// Lives at the repo root (not under app/), because this Next.js project
// uses `output: "export"` for the GitHub Pages build, which disables
// server-side API routes. Vercel picks up a root-level /api directory as
// serverless functions independently of the Next.js static export, so this
// still works when deployed there.
//
// Env var required (Vercel → Project → Settings → Environment Variables):
//   CODEWORDS_API_KEY - the Bearer key for the Codewords agent
//
